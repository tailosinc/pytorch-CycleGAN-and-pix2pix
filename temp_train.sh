...
#L1=200
#PHASE=train_2ndpass_noRooms_L1400

python3.7 train.py --dataroot $DATAROOT --name $NAME --model pix2pix --crop_size 256 --preprocess scale_maintain_ratio_and_crop --lambda_L1 $L1 --phase $PHASE
